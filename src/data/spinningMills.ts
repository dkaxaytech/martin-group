...
export const spinningCompany = {
  ...
  legalName: 'Windfarm Spinning Mills Private Ltd',
  ...
  email: 'spinning@windfarm.com',
  phone: '+91 422 000 0000',
  address: 'Windfarm Spinning Mills, Near Coimbatore, Tamil Nadu, India',
}
...
export const spinningAbout = {
  ...
  paragraphs: [
    ...
    'Looking ahead, we are expanding toward more than 100,000 spindles while strengthening ISO-aligned quality practices — ensuring Windfarm Spinning Mills remains a symbol of trust in India’s textile value chain.',
  ],
}
...
export const spinningJourney: JourneyMilestone[] = [
  {
    ...
    description:
      'Windfarm Spinning Mills began operations near Coimbatore with an inaugural capacity of 10,000 spindles.',
  },
  {
    year: 'Growth',
  ...
  {
    year: 'Expansion',
    title: 'Windfarm Fabrics Established',
    description:
      'The group extended its textile footprint with Windfarm Fabrics, strengthening downstream capabilities.',
  },
  {
    year: 'Today',
...
export const spinningGallery: GalleryItem[] = [
  {
    ...
    alt: 'Windfarm Spinning Mills manufacturing environment',
    category: 'Plant',
  },
  {
    id: 'sg2',
