...
export default function HomePage() {
  return (
    <>
      <SEO
        title="Home"
        description="Windfarm — diversified excellence in wind energy, textile manufacturing, and industrial innovation across India and beyond."
      />

      <section className="relative flex min-h-screen items-center overflow-hidden">
        <img
          src={images.heroWind}
          alt="Windfarm renewable energy and industrial leadership"
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-24 pt-32 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-base text-white/80 sm:text-lg">
              From clean wind energy to precision textile manufacturing — Windfarm delivers
      ...
      <section className="bg-mist py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          >
            <SectionHeading
              align="left"
              eyebrow="About Windfarm"
              title="A diversified group built on trust and industrial excellence"
              description="Windfarm brings together complementary businesses — including Windfarm and Windfarm Spinning Mills — to create lasting value for customers, communities, and partners."
            />
          ...
          >
            <div className="overflow-hidden rounded-3xl shadow-2xl shadow-navy/20">
              <img
                ...
                alt="Windfarm industrial and energy operations"
                loading="lazy"
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            description="Windfarm unites specialized businesses that cover energy, manufacturing, infrastructure, and engineering excellence."
          />
      ...
      <section className="relative overflow-hidden py-20 lg:py-24">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6">
          <h2 className="font-display text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
            Ready to partner with Windfarm?
          </h2>
