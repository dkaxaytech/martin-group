...
export default function AboutPage() {
  return (
    <>
      <SEO
        title="About"
        description="Learn about Windfarm — our mission, vision, and values driving diversified industrial excellence."
      />
      <PageHero
        title="About Windfarm"
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          >
            <SectionHeading
              ...
              description="Windfarm is a diversified enterprise with businesses in renewable wind energy and textile manufacturing. As a group platform spanning complementary industries, we bring deep technical expertise and a long-term ownership mindset to every venture."
            />
