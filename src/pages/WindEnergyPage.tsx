...
export default function WindEnergyPage() {
  return (
    <>
      <SEO
        title="Wind Energy"
        description="Discover how Windfarm projects work — technology, benefits, and the power generation process."
      />
      <PageHero
        title="Wind Energy"
            ...
            <div className="grid lg:grid-cols-2">
              <div className="p-8 sm:p-12">
                ...
                <p className="mt-4 text-white/70 leading-relaxed">
                  Windfarm deploys high-capacity turbines, digital twins, and advanced foundation
