...
export default function SpinningMillsPage() {
  ...
  return (
    <>
      <SEO
        title="Windfarm Spinning Mills"
        description="Windfarm Spinning Mills — premium yarn manufacturing near Coimbatore with 80,000+ spindles, ISO quality practices, and nationwide supply across India."
      />
      ...
      <section className="relative flex min-h-[88vh] items-center overflow-hidden">
        <img
          ...
          alt="Windfarm Spinning Mills yarn production floor"
      ...
      <section className="bg-white py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          >
            <img
              src={images.textileFactory}
              alt="Windfarm Spinning Mills manufacturing floor"
              loading="lazy"
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            title="Why leading buyers choose Windfarm Spinning Mills"
          />
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            eyebrow="Gallery"
            title="Inside Windfarm Spinning Mills"
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6">
          <h2 className="font-display text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
            Ready to Partner With Windfarm Spinning Mills?
          </h2>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            eyebrow="Contact"
            title="Connect with Windfarm Spinning Mills"
